...
const Navbar = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-30 h-20 transition-all duration-400 ${scroll ? 'scrolled' : ''}`}>
        ...
        <button className='w-35 bg-gradient-to-br from-pink-400 to-purple-500 cursor-pointer rounded-3xl relative right-27 bottom-1 text-white font-bold hover:scale-[1.1] transition-transform jost-font'>Get Started</button>
    </div>
    </div>
  )
}
